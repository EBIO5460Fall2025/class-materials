...
Quantiles are the inverse of this function: the value of x for which the cumulative probability is p. For example, what value of x is 80% of the values of x expected to be less than? The quantile is given by `qnorm()`.
...
The basic idea of a QQ (quantile-quantile) plot is to plot the empirical quantiles (i.e. from the data) against the theoretical quantiles of the distribution in question (e.g. Normal, Poisson, etc).
