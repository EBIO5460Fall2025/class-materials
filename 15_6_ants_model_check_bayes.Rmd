...
This script performs some basic model checking of a Poisson log-link GLM trained on the ants data, highlighting the use of posterior predictive checks in `rstanarm`.
