...
# Let's say the weights of individuals in the population follow a normal distribution. This is
# arbitrary, and it could in fact be any kind of distribution. Let's say the mean weight of an individual in the population is around 0.1 grams (which
# seems the right ballpark for the species shown in the picture) with a standard deviation around
# 0.02 (weights vary by about 20% of the mean).
...
true_weights[100,]  #the population
