...
**Due:** Tuesday 13 Oct 3:30 PM

**Grading criteria:** Complete the code and include the comment in Q1. On time submission.

**Format for submitting solutions:**

* Submit one file of Python code and your datafile
* The filenames should be `train_ssq_grid.py`, and `data/mydat.csv` but you can add any prefixes to the filenames that work with your file naming scheme. 
